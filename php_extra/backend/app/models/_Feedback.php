<?php
  ...
  class _Feedback {
    ...
    public function showSingle($id) {
      $this->db->query('SELECT * FROM tbl_feedback WHERE ID = :id');
      $this->db->bind(':id', $id);
      return $this->db->resultSet();
    }
    ...
    public function add($data) {
      ...
      $this->db->query('INSERT INTO  tbl_feedback (NAMES, EMAIL, MESSAGES) VALUES (:names, :rating, :messages)');

      //Binding Variables
      $this->db->bind(':names', $data["NAMES"]);
      $this->db->bind(':rating', $data["EMAIL"]);
    ...
    public function update($data, $id) {
      ...
      //Adding data to database
      $this->db->query('UPDATE tbl_feedback SET NAMES = :names, EMAIL = :rating, MESSAGES = :messages WHERE ID = :id');

      //Binding Variables
      $this->db->bind(':id', $id);
      $this->db->bind(':names', $data["NAMES"]).value;
      $this->db->bind(':rating', $data["EMAIL"]).value;
